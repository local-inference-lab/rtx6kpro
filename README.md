...
| DS4 text serving profile | [DeepSeek-V4-Flash Jovian Judgement r7](models/ds4-jovian-judgement-r7.md) | Source-locked TP2 fixed-K5 serving with InstantTensor loading, GPU KV defaults, and an engine-driven LMCache path qualified across all hybrid KV groups. |
